...
interface KeelAPI {
    queries: {
        getServerStatus: (i?: GetServerStatusInput) => Promise<APIResult<ServerStatusReturn>>;
        listTodos: (i: ListTodosInput) => Promise<APIResult<{ results: Todo[], pageInfo: PageInfo }>>;
        listUsers: (i?: ListUsersInput) => Promise<APIResult<UsersReturn>>;
    },
    mutations: {
        ...
        createTodo: (i?: CreateTodoInput) => Promise<APIResult<Todo>>;
        updateTodo: (i: UpdateTodoInput) => Promise<APIResult<Todo>>;
        deleteTodo: (i: DeleteTodoInput) => Promise<APIResult<string>>;
        deleteTodoSoft: (i: DeleteTodoSoftInput) => Promise<APIResult<Todo>>;
    }
}
